...
using StarWars.WebApi.Areas.HelpPage.ModelDescriptions;

namespace StarWars.WebApi.Models
{
    /// <summary>Represents the possible allegiances.</summary>
    // Serialize to string value
    [JsonConverter(typeof(StringEnumConverter))]
    public enum Allegiance
    {
        /// <summary>Represents no allegiance.</summary>
        [EnumMember(Value = "None")]
        None = 0,

        /// <summary>
        ///     Represents allegiance to the Alliance to Restore the Republic, commonly known as
        ///     the Rebel Alliance, its formative resitance groups, or its successor state, the
        ///     New Republic.
        /// </summary>
        ...
        /// <summary>
        ///     Represents allegiance to the Galactic Empire, the Imperial Remnant, or its
        ///     successor military junta, the First Order.
        /// </summary>
        [EnumMember(Value = "Empire")]
        Empire,
    }

    /// <summary>Represents the possible trilogies.</summary>
    // Serialize to string value
    [JsonConverter(typeof(StringEnumConverter))]
    public enum Trilogy
    {
        /// <summary>Represents no trilogy.</summary>
        [EnumMember(Value = "None")]
        None = 0,
        ...
        /// <summary>
        ///     Represents the prequel trilogy: Episodes I "The Phantom Menace", II "Attack of
        ///     the Clones", and III "Revenge of the Sith".
        /// </summary>
    ...
    /// <summary>Represents a character in the Star Wars universe.</summary>
    [ModelName("Character")]
    public class CharacterModel
    {
        ...
        /// <value>An <see cref="Allegiance">allegiance</see> from the set of options.</value>
        ...
        /// <value>An <see cref="Trilogy">trilogy</see> from the set of options.</value>
