...
namespace StarWars.Data.DataAccess
{
    public interface IDAL
    {
        ...
        /// <summary>Executes a stored procedure with parameters, returning a single value.</summary>
        ...
        /// <inheritdoc cref="ExecuteStoredProcedure(string, Dictionary{string, object})"/>
        /// <summary>
        ///     Executes a stored procedure with parameters, returning a
        ///     <see cref="DataTable">table</see>.
        /// </summary>
        /// <returns>
        ///     The first <see cref="DataTable">table</see> in the result set returned from the stored
        ///     procedure.
        /// </returns>
